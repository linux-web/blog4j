...
public interface IPostService {
	...
	// 发布的文章
	public static final String PUBLISH_POST = " type='" + TYPE_POST + "' and status='" + STATUS_PUBLISH + "'";
	// 发布的页面
	public static final String PUBLISH_PAGE = " type='" + TYPE_PAGE + "' and status='" + STATUS_PUBLISH + "'";
