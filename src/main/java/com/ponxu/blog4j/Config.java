...
public class Config {
	...
	private static void loadCloudFoundry() {
		try {
			...
			// mysql
			JSONObject mysqlCfg = json.getJSONArray("mysql-5.1").getJSONObject(0).getJSONObject("credentials");
			...
			// mongodb用于文件存储
			JSONObject mgCfg = json.getJSONArray("mongodb-2.0").getJSONObject(0).getJSONObject("credentials");
	...
	public static String show() {
		return "Config [isSAE=" + isSAE + ", isCloudFoundry=" + isCloudFoundry + ", theme=" + theme + ", pageSize="
				+ pageSize + ", cache=" + cache + ", sublength=" + sublength + ", dbUser=" + dbUser + ", dbPassword="
				+ dbPassword + ", dbName=" + dbName + ", dbHost=" + dbHost + ", dbPort=" + dbPort + ", dbUser2="
				+ dbUser2 + ", dbPassword2=" + dbPassword2 + ", dbName2=" + dbName2 + ", dbHost2=" + dbHost2
				+ ", dbPort2=" + dbPort2 + "]";
	}
